...
**Thoughts** 
- I figured out User and Item-Based Collaborative Filtering. Studied how to deploy recommendation systems. Also worked with matrices.

**Link(s) to work**
[Code on Github](https://github.com/makarevichy/Week_10_100DaysOfCode/blob/master/weekday/Days_66_67.R)
...
**Thoughts** 
- I started to study a new extensive topic - recommendation systems. I plan to devote a few days to it to thoroughly understand.

**Link(s) to work**
[Code on Github](https://github.com/makarevichy/Week_10_100DaysOfCode/blob/master/weekday/Day_65.R)

### Day 64: July 22, Sunday.

**Today's Progress**: Functions.

**Thoughts** 
- I continued to dive into the functionality of R.
...
**Thoughts** 
- Today I finished the basic course on Python. And received a certificate ))

![Certificate python3](https://github.com/makarevichy/100-days-of-code/blob/master/img/cert_python3.jpg)

### Day 60: July 18, Wednesday.

**Today's Progress**: Python.

**Thoughts** 
- I continued to study the Python. The topics that I was able to get acquainted with are functional programming and object-oriented programming.

### Day 59: July 17, Tuesday.

**Today's Progress**: data.table package.

**Thoughts** 
- Today I worked in R with a wonderful data package.table specially created for large tables.
- I began to actively study Python.

**Link(s) to work**
[Code on Github](https://github.com/makarevichy/Week_9_100DaysOfCode/blob/master/weekday/Day_59.R)

### Day 58: July 16, Monday.

**Today's Progress**: Html.

**Thoughts** 
- Decided to recall the basics of HTML :)

![Certificate html](https://github.com/makarevichy/100-days-of-code/blob/master/img/cert_html.jpg)

### Day 57: July 15, Sunday.

**Today's Progress**: R and databases.

**Thoughts** 
- I study in more detail the interaction of R with a remote database using packages: dplyr, dbplyr, DBI and RSQLite.

**Link(s) to work**
[Code on Github](https://github.com/makarevichy/Week_9_100DaysOfCode/blob/master/weekday/Day_57.R)
...
**Thoughts** 
- Today I worked with VGG 16 neural network as well as imagenet weights.
